...
{
    public class AttenteMoyenObjectController : Controller
    {
        public ActionResult Index()
        {
            AttenteMoyenObject tempsAttenteMoyen = null;
            ...
            using (var client = new HttpClient())
            {
                ...
                {
                    var readTask = result.Content.ReadAsAsync<AttenteMoyenObject>();
                    readTask.Wait();
